...
function handleUpadte() {
    ...
    payload.append("publish_at", form.publish_at);
...
const populateFormEdit = (entity) => {
    ...
    form.publish_at = entity.publish_at;
};
</script>
...
<template>
    ...
    >
        <template v-for="ann in announcements.data" :key="ann.id">
            <div
                v-if="ann.should_show"
