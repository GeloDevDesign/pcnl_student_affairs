<template>
    ...
    <div v-if="isOpen" class="fixed inset-0 z-50 overflow-y-auto">
        <!-- Backdrop -->
        <div
            class="fixed inset-0 bg-white bg-opacity-95 transition-opacity"
            @click="handleClose"
        ></div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        >
                            <div class="flex flex-col items-center flex-1">
                                ...
                                <span
                                    class="text-xs mt-2 text-center hidden md:block"
                                    >{{ step.title }}</span
                                >
                            </div>
                            <div
                ...
                <div class="p-6 overflow-y-auto max-h-[calc(90vh-250px)]">
                    ...
                    <div v-show="currentStep === 1">
                        ...
                        <p class="text-sm text-gray-600 mb-4">
                            Add political parties or groups participating in
                            this election.
                        </p>
                        ...
                        <div class="space-y-2">
                            ...
                            >
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-8 h-8 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center font-semibold"
                                    >
                                        {{ index + 1 }}
                                    </div>
                            ...
                            >
                                ...
                                <p>
                                    No parties added yet. Add your first party
                                    above.
                                </p>
                            </div>
                        </div>
                    ...
                    <div v-show="currentStep === 2">
                        ...
                        <p class="text-sm text-gray-600 mb-4">
                            Default positions are already added. You can add
                            more if needed.
                        </p>
                        ...
                        <div class="space-y-2">
                            ...
                            >
                                ...
                                <p>
                                    No roles added yet. Add your first role
                                    above.
                                </p>
                            </div>
                        </div>
                    ...
                    <div v-show="currentStep === 3">
                        ...
                        <p class="text-sm text-gray-600 mb-4">
                            Add candidates for each position and party.
                        </p>
                        ...
                        <div class="space-y-2">
                            ...
                            >
                                <div class="flex gap-3 flex-1">
                                    <div
                                        class="w-10 h-10 bg-purple-100 text-purple-600 rounded-full flex items-center justify-center font-semibold flex-shrink-0"
                                    >
                                        {{ index + 1 }}
                                    </div>
                                    <div class="flex-1">
                            ...
                            >
                                ...
                                <p>
                                    No candidates added yet. Add your first
                                    candidate above.
                                </p>
                            </div>
                        </div>
...
const canProceed = computed(() => {
    switch (currentStep.value) {
        case 0:
            return (
                electionData.value.name.trim() &&
                electionData.value.start_date &&
                electionData.value.start_time && // Added validation
                electionData.value.end_date &&
                electionData.value.end_time
            ); // Added validation
        case 1:
...
function addCandidate() {
    if (
        newCandidate.value.full_name.trim() &&
